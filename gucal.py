...
def dateselector():
    ...
    e1 = DateEntry(master,width=12,year=2019,month=6,day=22,background='darkblue', foreground='white', borderwidth=2)
    e2 = DateEntry(master,width=12,year=2019,month=6,day=22,background='darkblue', foreground='white', borderwidth=2)
    e3 = DateEntry(master,width=12,year=2019,month=6,day=22,background='darkblue', foreground='white', borderwidth=2)
    e4 = DateEntry(master,width=12,year=2019,month=6,day=22,background='darkblue', foreground='white', borderwidth=2)
