...
for k in range(1,ws.max_row):
    NETINCOME.append(round(afterFees(SOURCE[k],TOTALPAYOUT[k])-(CLEANINGFARE[k]+CITYTAX[k]+LOCALTAX[k]),2))
...
# --------------- End: Calculate Net Income by remainders after taxes and cleaning fare
# --------------- Begin: Populate NET INCOME and COMMISSION
...
# --------------- End: Populate NET INCOME and COMMISSION
# -----------------------------------------------------------------------
